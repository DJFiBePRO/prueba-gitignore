...
<main>
	<div class="page__data">
		<div class="data__title">
			<h1>{{$types->cultural_management_types_name}} </h1>
		</div>
		<div class="data__name">
			<p class="name__content">DESCRIPCIÓN</p>
		</div>
		<div class="data__content">
			@if($types->cultural_management_types_description != null)
			<p class="content__descrip">{!!$types->cultural_management_types_description!!}</p>
			@else
		...
		<div class="data__date">
			...
			<p class="date__info">{{$types->cultural_management_types_create->format('Y-M-d')}} </p>
			<label class="date__label">Fecha de Modificación:</label>
			<p class="date__info">{{$types->cultural_management_types_update->format('Y-M-d')}}</p>
		</div>
		...
		<div class="data__multimedia">
			...
			<div class="multimedia__img">
				<div class="img__imagen">
					<img src="{{asset('img/culturalManagementTypes/'.$multi->multimedia_name)}}" alt="">
				</div>
				<div class="img__form">
		...
		<div class="data__name">
			<div class="name__link">
				<a class="fa fa-chevron-circle-left" href="{{route('culturalManagementTypes')}}"> Atras</a>
			</div>
		</div>
	</div>
