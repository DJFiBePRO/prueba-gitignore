...
<section>
	<div class="page__update">
		<form method="POST" action="{{route('updateMultimediaType')}}" class="action__form" enctype= multipart/form-data>
			...
			<div class="form__container">
				...
				<div class="container__item">
					<input type="text" name="multimediaDescription" >
				</div>					
			</div>
	...
	<div class="page__main">
		...
		<div class="main__insert">
			...
			<div class="insert__form">
				<form method="POST" action="{{route('multimediaType')}}" class="action__form" id="form__insert" enctype="multipart/form-data">
					<input type="hidden" name="_token" value="{{csrf_token()}}">
		...
		<div class="main__content">
			<h2>Tipos de multimedia Existentes </h2>
			<table  class="content__table" id="multimedia">
				...
				<tbody>
					...
					<tr class="data__info" 
					data-id="{{$categoryData->multimedia_type_id}}"
					data-descripcion="{{$categoryData->multimedia_type_description}}">
					<td>{{$categoryData->multimedia_type_description}}</td>
					<td>
				...
				@empty
				<tr >
					<td colspan="2" class="table__msj">! No hay tipos de multimedia registrados...</td>
				</tr>
				@endforelse
...
<script type="text/javascript">
	...
	function cargarFormulario(datos){
		...
		$(".action__form input[name=multimediaDescription]").val(datos['descripcion']);
	}
