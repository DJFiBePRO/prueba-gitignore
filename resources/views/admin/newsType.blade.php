...
<section>
	<div class="page__update">
		<form method="POST" action="{{route('updateNewsType')}}" class="action__form" enctype= multipart/form-data>
	...
	<div class="page__main">
		...
		<div class="main__insert">
			...
			<div class="insert__form">
				<form method="POST" action="{{route('newsType')}}" class="action__form" id="form__insert" enctype="multipart/form-data">
					<input type="hidden" name="_token" value="{{csrf_token()}}">
		...
		<div class="main__content">
			<h2>Tipos de noticias Existentes </h2>
			<table  class="content__table" id="news">
				...
				<tbody>
					...
					<tr class="data__info" 
					data-id="{{$categoryData->news_type_id}}"
					data-descripcion="{{$categoryData->news_type_description}}">
					<td>{{$categoryData->news_type_description}}</td>
					<td>
				...
				@empty
				<tr >
					<td colspan="2" class="table__msj">! No hay tipos de noticias registrados...</td>
				</tr>
				@endforelse
...
<script type="text/javascript">
	...
	function cargarFormulario(datos){
		...
		$(".action__form input[name=newsDescription]").val(datos['descripcion']);
	}
